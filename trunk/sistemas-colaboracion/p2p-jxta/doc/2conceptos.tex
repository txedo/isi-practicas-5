\section{Conceptos de JXTA} \label{sec:conceptos}
...
\subsection{Identificadores (\textit{IDs})}
...
Este ID se expresa en forma de URN (\textit{Uniform Resource Name}), que son una forma de URI (\textit{Uniform Resource Identifier)} destinados a servir como identificadores de recursos de manera persistente e independiente de la ubicación. En la Figura \ref{fig:URN} se puede observar un ejemplo de un ID de par JXTA.

\imagen{./imagenes/URN}{0.5}{Ejemplo de un ID de un par JXTA}{fig:URN}
