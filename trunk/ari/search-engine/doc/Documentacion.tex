...
\hypersetup{bookmarksopen,bookmarksopenlevel=3,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={Motor de indexación}, 
						pdfsubject={Almacenamiento y Recuperación de la Información}
						pdfauthor={Juan Andrada, Jose Domingo López}}
...
\input{Manual.tex}
\clearpage
%\input{Estadisticas.tex}
%\clearpage

\clearpage\phantomsection
% Añadimos la bibliografia al \'indice
