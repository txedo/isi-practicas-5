\section{Futuras mejoras} \label{mejoras}

\paragraph{Cache} Como se dice en la sección de estadísticas (sección
...
otro ámbito. Actualmente, el sistema lee línea a línea el
fichero que está parseando para su indexación, por lo que se están solicitando accesos a disco de forma
