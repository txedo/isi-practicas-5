...
\ref{fig:BD}. Las tablas que se representan son: 
...
\begin{milista}
	...
	\item En cada una de las palabras de la línea, se sustituyen
          ...
          en blanc y se divide la palabra por dichos espacios, obteniendo así una lista de palabras, que recibe
...
En resumen, este módulo parser se ha implementado para dar el mismo tratamiento a las cadenas de los documentos a indexar como a las cadenas de consultas.
...
opción es más eficiente en cuanto a tiempo, ya que sólo se vuelca el diccionario cuando se termina de procesar el documento, en lugar de ir accediendo a la base de datos por cada uno de los términos que se deben almacenar del documento.
