...
\hypersetup{bookmarksopen,bookmarksopenlevel=3,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={FAQ Manager: un gestor de preguntas frecuentes},
						pdfauthor={Juan Andrada Romero, Jose Domingo López López},
						pdfsubject={Multimedia, Hipermedia y Realidad Virtual}}
...
\input{1participantes.tex}
%\clearpage
\input{2introduccion.tex}
\clearpage
\input{3descripcionBD.tex}
%\clearpage
