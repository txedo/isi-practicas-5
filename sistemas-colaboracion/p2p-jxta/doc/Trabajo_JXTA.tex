...
\usepackage{eurosym} %para poder poner el símbolo del euro con \euro
...
\hypersetup{bookmarksopen,bookmarksopenlevel=3,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={JXTA - Aplicaciones Peer to Peer basadas en Java},
						pdfauthor={Juan Andrada Romero, Jose Domingo López López},
						pdfsubject={Sistemas para la Colaboración}}
...
\clearpage
\input{2conceptos.tex}
\clearpage
\input{3arquitecturaSW.tex}
\clearpage
\input{4arquitecturaRed.tex}
\clearpage
\input{5protocolos.tex}
\clearpage
\input{6demo.tex}
\clearpage
\input{7aplicacionesReales.tex}
