...
\hypersetup{bookmarksopen,bookmarksopenlevel=4,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={PlanCoDE: Planificador Colaborativo para el Diseño de Estrategias y Acciones de Emergencia},
...
\input{2queesplancode.tex}
\clearpage
\input{3clasificacion.tex}
...
\input{6manual.tex}
\clearpage
\section{Informe de división de trabajo}
