...
\hypersetup{bookmarksopen,bookmarksopenlevel=4,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={Análisis de un sistema colaborativo: Skype},
...
\clearpage
\input{2clasificacion.tex}
\clearpage
\input{3requisitos.tex}
\clearpage
\input{4funcionamiento.tex}
\clearpage
\input{5criticasypropuestas.tex}
